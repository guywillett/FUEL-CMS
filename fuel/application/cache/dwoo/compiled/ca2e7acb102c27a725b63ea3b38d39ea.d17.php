...
<p><code>#scroll_to_top{ z-index:33; border: 1px solid #77C62E; -webkit-border-radius: 100px 100px 100px 100px; -moz-border-radius: 100px 100px 100px 100px; -ms-border-radius: 100px 100px 100px 100px; -o-border-radius: 100px 100px 100px 100px; border-radius: 100px 100px 100px 100px; display:none; height: 36px; width: 36px; top: 50%; right: 2%; opacity: 0.8; position:fixed; background-color:#F1F1F1; } </code></p>

<p><code>#scroll_top span{ position:relative; top: 7px; left: 6px; }</code></p>

<p><code>a:focus{ outline:none!important; text-decoration:none!important; }</code></p>
