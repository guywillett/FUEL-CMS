...
In the top block we listen for the 'scroll' event on the window and use the jQuery function<code class="js inline">scrollTop()</code>to determine the distance in pixels from the top. Once more than 250px then we use the jQuery built in animation function called<code class="js inline">fadeIn()</code>to display the Scroll To Top button, and<code class="js inline">fadeOut()</code>to hide the button when the scroll position is less than 250 pixels from the top.</p>
