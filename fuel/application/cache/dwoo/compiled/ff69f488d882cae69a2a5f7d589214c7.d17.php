...
<p>I like responsively designed websites. &nbsp;I think they are cool. This website is a responsive design, and it&#8217;s cool. But is it necessary or desirable for every website? And what about web apps and mobile apps? &nbsp;With an ever increasing proportion of visitors using mobile devices rather than desktops for internet surfing this is a hot topic. And let&#8217;s remember that mobile devices have slower processors, less RAM (memory) and often rely on 3G. &nbsp;Here are some FAQs and Pros and Cons about these things:</p>
...
<p>Another good question! With a not too dissimilar answer to Responsive Design. &nbsp;Basically the choice is between a Hybrid App (an app built using web technologies and wrapped in PhoneGap or Kivvy or similar) and a Native App (an app built using the platforms native coding language eg Android +&nbsp;Java or iOS +&nbsp;Objective-C).</p>
